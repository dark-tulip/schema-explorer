# Добавление MongoDB коннектора в Кликхаус, из топика кафки
...
- Закончила с получением метаданных по столбцам документа из коллекции
...
- Закончила работу над АПИ info который по типу dbType монго дб, и регистрирует с ним соединение.
