...
В топике все совершенные операции над данными хранятся

соотв:

- перечитав все можно достичь конечного состояния (восстановление)
- запись пустышка это операция удаления
